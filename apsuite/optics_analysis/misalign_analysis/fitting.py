    ...
    **kargs:
    ...
    if "orbcorr_obj" in kwargs:
        ...
        if oc.respm.model != model:
            print(
                """> Passed model is different from the \
    ...
    if model is None:
        ...
        rtn_model_flag = True
        if trueapply is False:
            trueapply = True
            print(
                "When model isnt passed, a new model is\
    ...
    mat += base.resp_mat
    imat, *_ = _pinv(
        mat, svals=svals, cut=cut, return_svd=True
    )
