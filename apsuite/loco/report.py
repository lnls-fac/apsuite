...
class LOCOReport(FPDF):
    ...
    def header(self):
        ...
        self.image(
            path + '/cnpem_lnls_logo.jpg', x=10, y=6, w=40, h=15)
    ...
    def loco_fingerprint(self):
        ...
        for idx, row in enumerate(data):
            ...
            tab_h = table_cell_height/3 if idx == len(data) \
    ...
    def config_table(self):
        ...
        data = (
            ...
            ('Horizontal delta kicks', str(cfg.delta_kickx_meas*1e6)+' urad'),
            ('Vertical delta kicks', str(cfg.delta_kicky_meas*1e6)+' urad'),
    ...
    def add_tune_emit_and_optics(self):
        ...
        img_y = 185
        self.image(
            'dispersion.png', x=img_x, y=img_y, w=img_w, h=img_h)
        ...
        for idx, row in enumerate(df.itertuples()):
            ...
            for col in cols:
                ...
                self.cell(
                    ...
                    align='C', border=1)
            tab_h = table_cell_height/3 if idx == df.shape[0] \
                else table_cell_height
            self.ln(tab_h)
