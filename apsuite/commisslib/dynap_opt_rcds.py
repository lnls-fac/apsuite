...
class OptimizeDA(_RCDS):
    ...
    def old_objective_function(self, pos):
        """."""
        evg = self.devices['evg']
    ...
    def old_inject_beam(self, min_curr=2.0, timeout=10):
        ...
        egun_trigps = self.devices['egun_trigps']
