...
class Wire:
    ...
    def __init__(self, position, current):
        ...
        position : numpy.array of size 2
            Cartesian coordinates [x,y] of the wire position in meters.

        current : float, int
            Current in Amperes of the wire.
        """
        self.position = position  # [m]
        self.current = current    # [A]

    def calc_magnetic_field(self, r):
        """Computes the magnetic field generated by the wire in a set of points
        in space.
...
class NLK:
    ...
    def si_nlk_kick(
        ...
        integ_field = strength * mag_field * nlk_length
